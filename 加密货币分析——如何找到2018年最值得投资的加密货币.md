...
我的原则是，先看这个加密货币的总流通量是不是低于1亿（硬顶），要是它的通量低于5000万个就更好了。
...
加密货币价格也是由供求关系决定的。在流通量较小的情况下，如果有什么利好消息（比如项目开发进展以及合作伙伴加盟的预告），则会引发token需求的激增，这将迅速推高币的价格。如果在流通很大的情况下，即使需求量很大，市场的交易仍然波澜不惊，币价涨幅有限。
